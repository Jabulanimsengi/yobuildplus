...
function BuildersPage() {
    ...
    if ($[0] !== "6f32dc10ff7c62ed0f22f111ee29267c9a291b74ac615731d8c08a95253006a4") {
        for(let $i = 0; $i < 28; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6f32dc10ff7c62ed0f22f111ee29267c9a291b74ac615731d8c08a95253006a4";
    }
    ...
    const [selectedAttributes, setSelectedAttributes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    let results;
    if ($[2] !== searchQuery || $[3] !== selectedAttributes || $[4] !== selectedProvince || $[5] !== selectedRating) {
        results = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$data$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockBuilders"]
        ];
        if (searchQuery) {
            const query = searchQuery.toLowerCase();
            results = results.filter({
                "BuildersPage[results.filter()]": (b)=>b.name.toLowerCase().includes(query) || b.description.toLowerCase().includes(query) || b.city.toLowerCase().includes(query)
            }["BuildersPage[results.filter()]"]);
        }
        if (selectedProvince) {
            results = results.filter({
                "BuildersPage[results.filter()]": (b_0)=>b_0.provinces.includes(selectedProvince)
            }["BuildersPage[results.filter()]"]);
        }
        if (selectedRating) {
            results = results.filter({
                "BuildersPage[results.filter()]": (b_1)=>b_1.rating >= selectedRating
            }["BuildersPage[results.filter()]"]);
        }
        if (selectedAttributes.length > 0) {
            results = results.filter({
                "BuildersPage[results.filter()]": (b_2)=>selectedAttributes.every({
                        "BuildersPage[results.filter() > selectedAttributes.every()]": (attr)=>b_2.serviceAttributes.includes(attr)
                    }["BuildersPage[results.filter() > selectedAttributes.every()]"])
            }["BuildersPage[results.filter()]"]);
        }
        $[2] = searchQuery;
        $[3] = selectedAttributes;
        $[4] = selectedProvince;
        $[5] = selectedRating;
        $[6] = results;
    } else {
    ...
    const filteredBuilders = results;
    let t1;
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "BuildersPage[handleAttributeToggle]": (attribute)=>{
                setSelectedAttributes({
                    "BuildersPage[handleAttributeToggle > setSelectedAttributes()]": (prev)=>prev.includes(attribute) ? prev.filter({
                            "BuildersPage[handleAttributeToggle > setSelectedAttributes() > prev.filter()]": (a)=>a !== attribute
                        }["BuildersPage[handleAttributeToggle > setSelectedAttributes() > prev.filter()]"]) : [
                            ...prev,
                            attribute
                        ]
                }["BuildersPage[handleAttributeToggle > setSelectedAttributes()]"]);
            }
        })["BuildersPage[handleAttributeToggle]"];
        $[7] = t1;
    } else {
        t1 = $[7];
    }
    const handleAttributeToggle = t1;
    let t2;
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "BuildersPage[handleClearFilters]": ()=>{
                setSearchQuery("");
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = ({
            "BuildersPage[<Input>.onChange]": (e)=>setSearchQuery(e.target.value)
        })["BuildersPage[<Input>.onChange]"];
        $[11] = t5;
    } else {
        t5 = $[11];
    }
    ...
    let t7;
    if ($[14] !== selectedAttributes || $[15] !== selectedCategory || $[16] !== selectedProvince || $[17] !== selectedRating) {
    ...
    if ($[19] !== filteredBuilders.length) {
        ...
        $[19] = filteredBuilders.length;
        $[20] = t8;
    } else {
        t8 = $[20];
    }
    let t9;
    if ($[21] !== filteredBuilders) {
        t9 = filteredBuilders.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6",
            children: filteredBuilders.map(_BuildersPageFilteredBuildersMap)
        }, void 0, false, {
            fileName: "[project]/frontend/src/app/builders/page.tsx",
            lineNumber: 150,
            columnNumber: 40
...
_s(BuildersPage, "/KQIQCk9geLQYLTEvXQguofupEw=");
_c = BuildersPage;
function _BuildersPageFilteredBuildersMap(builder) {
...
//# sourceMappingURL=frontend_src_8b4ab34c._.js.map