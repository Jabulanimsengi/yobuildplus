...
import { ArrowRight, Loader2, AlertCircle, Eye, EyeOff, Mail, Lock, User, Briefcase, X, Check } from 'lucide-react';
...
export default function LoginPage() {
    ...
    const [selectedRole, setSelectedRole] = useState<'consumer' | 'service_provider' | null>(null);
                ...
                <div className="w-full bg-white rounded-2xl shadow-xl p-5 sm:p-6 flex items-center justify-center">
                    <div className="w-full max-w-md space-y-4">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 h-10 px-4 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 rounded-lg text-sm font-medium text-slate-700 transition-all"
                        >
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            >
                                <div className={cn(
                                    ...
                                    selectedRole === 'consumer' ? "bg-[#0EA5E9] text-white" : "bg-slate-100 text-slate-500 group-hover:bg-slate-200"
                                )}>
                                    <User className="h-6 w-6" />
                                </div>
                                <div className="flex-1">
                                    <div className="flex items-center justify-between">
                                        <h3 className={cn("font-semibold", selectedRole === 'consumer' ? "text-[#0EA5E9]" : "text-slate-900")}>
                                            Homeowner
                                        </h3>
                                        {selectedRole === 'consumer' && <Check className="h-5 w-5 text-[#0EA5E9]" />}
                                    </div>
