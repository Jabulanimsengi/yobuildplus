        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="bg-white border-b border-slate-200">
                <div className="container mx-auto px-4 py-4 md:py-8">
                    ...
                    <h1 className="text-2xl md:text-4xl font-bold text-slate-900 mb-2 md:mb-4">{name}</h1>
                    <p className="text-base md:text-xl text-slate-600 max-w-3xl">{description}</p>
                </div>
            </div>
                    ...
                    <div className="flex-1">
                        <div className="mb-3 md:mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                            <p className="text-sm md:text-base text-slate-600">
                                <span className="font-bold text-slate-900">{builders.length}</span> results
                            </p>
